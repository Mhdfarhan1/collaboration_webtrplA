...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'demo_url' => 'Tautan Demo',
        'semester' => 'Semester',
        'project_manager_id' => 'Project Manager',
        'tech_name' => 'Nama Teknologi',
        'tech_icon' => 'Ikon Teknologi',
        'member_name' => 'Nama Anggota',
        'member_nim' => 'NIM Anggota',
        'member_image' => 'Foto Anggota',
        'instagram_url' => 'Instagram URL',
        'linkedin_url' => 'LinkedIn URL',
        'github_url' => 'GitHub URL',
        'member_is_core' => 'Anggota Inti',
        'lecturer_name' => 'Nama Lengkap',
        'lecturer_title' => 'Gelar Akademik',
        'lecturer_nip' => 'NIK / NIP',
        'lecturer_position' => 'Jabatan / Struktural',
        'lecturer_email' => 'Email Institusi',
        'lecturer_expertise' => 'Bidang Spesialis',
        'last_education' => 'Pendidikan Tertinggi',
        'education_history' => 'Riwayat Pendidikan',
        'lecturer_type' => 'Tipe Pendidik',
        'is_advisor' => 'Dosen Pembimbing',
        'album_name' => 'Nama Album',
        'album_description' => 'Deskripsi Album',
