...
class LecturerController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'lecturer_title' => 'nullable|string|max:255',
            'lecturer_nip' => 'nullable|string|max:255',
            'lecturer_image' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:2048',
            'lecturer_position' => 'nullable|string|max:255',
            'lecturer_email' => 'nullable|email|max:255',
            'last_education' => 'nullable|string|max:255',
            'education_history' => 'nullable|string',
            'lecturer_expertise' => 'nullable|string|max:255',
