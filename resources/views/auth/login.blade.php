    ...
    <div class="w-full max-w-md glass-card rounded-[2.5rem] p-8 md:p-10 relative overflow-hidden reveal z-10">
        ...
        <div class="relative z-10">
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-black text-slate-800 mb-2">Login Account</h1>
           ...
           <form action="{{ route('login.process') }}" method="POST" class="space-y-6">
                ...
                <div class="flex items-center justify-end text-sm">
                    <a href="{{ route('password.request') }}" class="text-brand-600 font-bold hover:text-brand-700 transition-colors text-xs uppercase tracking-wider">
                        Lupa Password?
                    </a>
                </div>
