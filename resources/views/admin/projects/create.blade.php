                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select id="project_type" name="project_type" required
                            ...
                            <option value="Web Application" {{ old('project_type', 'Web Application') == 'Web Application' ? 'selected' : '' }}>Web Application</option>
                            <option value="Mobile Application" {{ old('project_type') == 'Mobile Application' ? 'selected' : '' }}>Mobile Application</option>
                            <option value="IoT & Hardware" {{ old('project_type') == 'IoT & Hardware' ? 'selected' : '' }}>IoT & Hardware</option>
                            <option value="Desktop Application" {{ old('project_type') == 'Desktop Application' ? 'selected' : '' }}>Desktop Application</option>
                            <option value="AI & Data Science" {{ old('project_type') == 'AI & Data Science' ? 'selected' : '' }}>AI & Data Science</option>
