        ...
        <div class="relative z-10 flex flex-col lg:flex-row gap-8 lg:gap-20">
            <div class="shrink-0">
                <h2 class="text-4xl md:text-5xl font-black text-white mb-3">
                    Who We <br>
                    <span class="bg-gradient-to-r from-amber-400 to-orange-400 bg-clip-text text-transparent">Are?</span>
                </h2>
            ...
            <div class="max-w-3xl">
                ...
                <p class="text-sm md:text-base text-slate-400 mt-4 border-l-4 border-slate-700 pl-4">
                    Focusing on <span class="text-amber-400 font-bold">{{ $s['about_focus_keyword'] ?? 'Software Development' }}</span>,
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 reveal">
        ...
        <a href="{{ $links['schedule']->link_url }}" target="_blank"
            ...
            <div class="flex flex-col justify-center h-full relative z-10">
                ...
                <p class="text-[10px] text-slate-400 font-medium group-hover:text-slate-600 transition-colors italic font-serif">List of Courses</p>
            </div>
            <div
        ...
        <a href="{{ $links['notion']->link_url }}" target="_blank"
            ...
            <div class="flex flex-col justify-center h-full relative z-10">
                ...
                <p class="text-[10px] text-slate-400 font-medium group-hover:text-slate-600 transition-colors italic font-serif">Notes & Projects</p>
            </div>
            <div
        ...
        <a href="{{ route('projects') }}"
            ...
            <div class="flex flex-col justify-center h-full relative z-10">
                ...
                <p class="text-[10px] text-slate-400 font-medium group-hover:text-slate-600 transition-colors italic font-serif">List of Our Portfolios</p>
            </div>
            <div
...
<section id="activities" class="px-4 md:px-0 w-[92%] max-w-6xl mx-auto pb-24 pt-10">
    ...
    <div class="mt-12 text-center reveal">
        <a href="{{ route('activities') }}"
            ...
            <i data-lucide="arrow-right" class="w-4 h-4 text-blue-600 group-hover:text-cyan-400 transition-transform group-hover:translate-x-1"></i>
        </a>
    </div>
</section>
        ...
        <div
            ...
            <div class="relative h-full flex flex-col items-center justify-center z-10 p-6">
                ...
                <h4 class="text-white font-bold text-lg md:text-xl text-center leading-tight">
                    View All <br>
                    <span
                        class="text-slate-400 group-hover:text-blue-100 transition-colors duration-300 font-serif italic">Photo Gallery</span>
                </h4>
...
<section id="members" class="px-4 md:px-0 w-[92%] max-w-6xl mx-auto pb-24 pt-10">
    <div class="flex flex-col items-center text-center mb-12 reveal">
        ...
        <h2 class="text-3xl md:text-5xl font-black text-slate-900 tracking-tight mb-4">
            Meet The <span class="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">Squad Members</span>
        </h2>
        <p class="text-slate-500 text-sm max-w-xl font-medium">Talented students of TRPL A Morning collaborating in works and innovation.</p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 reveal">
        @forelse($members as $member)
            <div class="group relative cursor-pointer perspective">
                {{-- Card Container --}}
                <div class="relative h-[420px] overflow-hidden rounded-[2rem] shadow-sm bg-slate-900 transition-all duration-500 hover:-translate-y-2 hover:shadow-xl hover:shadow-blue-900/20">
                    ...
                    @else
                        <div class="w-full h-full bg-gradient-to-br from-blue-700 to-indigo-900 flex items-center justify-center text-white font-extrabold text-3xl opacity-85 group-hover:opacity-100 transition-opacity">
                            {{ strtoupper(substr($member->member_name, 0, 2)) }}
                        </div>
                    @endif

                    {{-- Gradient Overlay --}}
                    <div class="absolute inset-0 bg-gradient-to-t from-slate-950/95 via-slate-900/40 to-transparent opacity-90 group-hover:opacity-95 transition-opacity duration-300"></div>

                    {{-- Floating NIM Badge (Top Right) --}}
                    <div class="absolute top-6 right-5 z-10">
                        <div class="px-4 py-1.5 bg-blue-600 border border-blue-400/20 rounded-full flex items-center shadow-md">
                    ...
                    <div class="absolute bottom-0 left-0 w-full p-6 z-10">
                        ...
                        <div class="flex items-center gap-2 mb-2.5">
                            ...
                            <p class="{{ $member->member_is_core ? 'text-amber-400' : 'text-blue-400' }} text-[10px] font-bold tracking-[0.2em] uppercase">
                                {{ $member->member_is_core ? 'CORE TEAM' : 'MEMBER' }}
                            </p>
                        </div>

                        {{-- Nama --}}
                        <h3 class="text-xl font-extrabold text-white mb-1.5 leading-tight group-hover:text-blue-300 transition-colors line-clamp-1">
                            {{ $member->member_name }}
                        </h3>
...
<section id="projects" class="px-4 md:px-0 w-[92%] max-w-7xl mx-auto pb-32 pt-10">
    ...
    <div class="flex flex-col items-center text-center mb-12 reveal">
        ...
        <h2 class="text-3xl md:text-5xl font-black text-slate-800 tracking-tight">
            Made by <span class="bg-gradient-to-r from-cyan-500 to-blue-600 bg-clip-text text-transparent">TRPL A Morning.</span>
        </h2>
