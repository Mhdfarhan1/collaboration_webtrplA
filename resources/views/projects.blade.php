        ...
        <div class="container mx-auto px-6 max-w-7xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 reveal">
                ...
                <div class="bg-white rounded-3xl p-5 flex flex-col justify-between group hover:shadow-xl hover:shadow-blue-500/10 hover:border-blue-400/60 transition-all duration-500 hover:-translate-y-1.5 border border-slate-200/80 overflow-hidden relative">
                    <div>
                        ...
                        <div class="flex flex-wrap gap-1.5 mb-3 px-1">
                            @forelse($project->projectTechs as $tech)
                                <span class="px-2.5 py-1 rounded-lg bg-blue-50/80 text-blue-700 text-[10px] font-extrabold uppercase border border-blue-100 inline-flex items-center gap-1">
                                    <i data-lucide="code-2" class="w-3 h-3 text-blue-500"></i>
                                    {{ $tech->tech_name }}
                                </span>
                            @empty
                    ...
                    <!-- Footer Section: Dev Team Avatars & Detail Case Study Link -->
                    <div class="pt-4 border-t border-slate-100 flex items-center justify-between gap-3 px-1 mt-2">
                        ...
                        <a href="{{ route('projects.detail', \App\Helpers\SecurityHelper::encode($project->project_id)) }}"
                            class="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-bold text-blue-600 bg-blue-50 border border-blue-100 hover:bg-blue-600 hover:text-white transition-all shadow-2xs group/btn">
                            <span>Detail</span>
